...
from producec import generate_one
...
def handle(title) -> None:
	...
	try:
		...
		dp_ob['title'] = title
		dp_ob['date'] = noww
		generate(html_file_name+".html",title=title,date=noww)
